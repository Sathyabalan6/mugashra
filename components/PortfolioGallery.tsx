...
export function PortfolioGallery({ items }: PortfolioGalleryProps) {
  ...
  // Manage focus and Escape/Arrow keys for modal
  useEffect(() => {
  ...
  }, [lightboxItem, activeCategory, currentIndex])
            ...
            <ViewTransition enter="scale-in" exit="scale-out">
              ...
              >
                ...
                <div className="absolute top-4 right-4 z-10 flex items-center gap-2">
                  <button
                    onClick={handlePrev}
                    className="w-10 h-10 rounded-full bg-[var(--color-text)] text-white hover:bg-[var(--color-accent)] flex items-center justify-center text-sm transition-colors"
