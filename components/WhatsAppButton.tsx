...
export function WhatsAppButton() {
  return (
    <Link
      href="/contact"
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2.5 px-5 py-3 min-h-[44px] bg-[var(--color-text)] text-[#FAFAF8] border border-[var(--color-text)] shadow-xl hover:bg-[var(--color-accent)] hover:border-[var(--color-accent)] transition-colors duration-300 group"
