...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 flex items-center gap-2.5 px-5 py-3 min-h-[44px] bg-[#25D366] text-white shadow-2xl hover:bg-[#20ba5a] transition-all duration-300 rounded-full group font-sans text-xs font-semibold uppercase tracking-[1.5px] active:scale-[0.98]"
