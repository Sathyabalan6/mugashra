          ...
          <div className="lg:col-span-6 space-y-8 text-left">
            ...
            <div className="p-6 sm:p-8 bg-[#181514] text-white space-y-4 border border-white/10 shadow-lg">
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2.5 px-6 py-3.5 bg-[var(--color-accent)] hover:bg-[var(--color-accent-hover)] text-[#181514] font-sans text-xs uppercase tracking-[2px] font-semibold transition-all duration-300 rounded-xs shadow-md min-h-[44px] w-full sm:w-auto active:scale-[0.98]"
              >
