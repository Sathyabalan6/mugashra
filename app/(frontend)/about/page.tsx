        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          <div className="space-y-6 text-left">
            <div className="space-y-2">
              <span className="font-sans text-xs sm:text-sm uppercase tracking-[2.5px] text-[#9E6D47] font-semibold block">Our Approach</span>
          ...
          <div className="space-y-6 text-left">
            <div className="space-y-2">
              <span className="font-sans text-xs sm:text-sm uppercase tracking-[2.5px] text-[#9E6D47] font-semibold block">Atelier Technique</span>
              <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl tracking-[0.12em] uppercase text-[#181514] font-normal leading-tight">
                THE CRAFT
              </h2>
            </div>
      ...
      <section className="py-20 sm:py-28 px-6 sm:px-12 bg-[#181514] !text-white border-t border-white/10">
        <div className="max-w-[1300px] mx-auto space-y-12">
          <div className="text-center space-y-3 max-w-2xl mx-auto">
            <span className="font-sans text-xs sm:text-sm uppercase tracking-[3px] !text-[#E2C4A8] font-semibold block">
            ...
            <p className="font-serif text-[15px] sm:text-base !text-[#E5DCD5] leading-relaxed font-light">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-6 text-center">
            <div className="p-4 sm:p-6 border border-[#443B37] bg-[#24201E] rounded-sm space-y-2 transition-colors hover:border-[#E2C4A8] hover:bg-[#2C2725]">
              ...
              <p className="font-sans text-xs sm:text-[13px] uppercase tracking-[1px] sm:tracking-[1.5px] !text-[#D8CBC0] font-medium">Airbrush Complexion</p>
            </div>
            <div className="p-4 sm:p-6 border border-[#443B37] bg-[#24201E] rounded-sm space-y-2 transition-colors hover:border-[#E2C4A8] hover:bg-[#2C2725]">
              <span className="font-serif text-base sm:text-xl !text-[#F5E6D8] font-medium block">Charlotte Tilbury</span>
              <p className="font-sans text-xs sm:text-[13px] uppercase tracking-[1px] sm:tracking-[1.5px] !text-[#D8CBC0] font-medium">Pillow Talk &amp; Filter</p>
            </div>
            <div className="p-4 sm:p-6 border border-[#443B37] bg-[#24201E] rounded-sm space-y-2 transition-colors hover:border-[#E2C4A8] hover:bg-[#2C2725]">
              <span className="font-serif text-base sm:text-xl !text-[#F5E6D8] font-medium block">Dior Backstage</span>
              <p className="font-sans text-xs sm:text-[13px] uppercase tracking-[1px] sm:tracking-[1.5px] !text-[#D8CBC0] font-medium">Radiant Glow Primers</p>
            </div>
            <div className="p-4 sm:p-6 border border-[#443B37] bg-[#24201E] rounded-sm space-y-2 transition-colors hover:border-[#E2C4A8] hover:bg-[#2C2725]">
              <span className="font-serif text-base sm:text-xl !text-[#F5E6D8] font-medium block">NARS &amp; Huda</span>
              <p className="font-sans text-xs sm:text-[13px] uppercase tracking-[1px] sm:tracking-[1.5px] !text-[#D8CBC0] font-medium">16-Hour Transferproof</p>
            </div>
          </div>
        </div>
      </section>
